...
const mockCards: ICard[] = [
  {
    ...
    name: 'Reset password button not working',
  ...
  },
  {
    ...
    name: 'Create clear filters button',
  ...
  },
  {
    ...
    name: 'Send first deploy to prod',
    description: '',
    status: IStatus.TO_DO,
    hidden: false
  },
  ...
  },
  {
    ...
    name: 'Make the onDragEnd function more efficient',
    description: '',
    status: IStatus.TO_DO,
    hidden: false
  },
  {
    ...
    name: 'Send first deploy to develop environment',
    description: '',
    status: IStatus.DONE,
    hidden: false
  },
